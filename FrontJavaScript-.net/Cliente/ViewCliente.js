    ...
    body(){
        ...
        .then(function(response){
            ...
            tr.innerHTML=`<td>
                            ...
                            <td>`+user.cnpj_cli+`</td>
                            <td>`+user.vendedor.nome+`<div class="d-inline-block text-truncate" style="margin-left:-0.5rem; margin-right:-0.5rem; width: 200px;"></div></td>
                            <td>`+user.vendedor.cnpj_Vend+`</td>
                            <td class="col-1">
